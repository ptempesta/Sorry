...
def create_screen(sorry_board):
    ...
    occupying_pawns[51] = True
    colored_pawns[51] = "blue"
    ...
    occupying_pawns[24] = True
    colored_pawns[24] = "yellow"
    occupying_pawns[49] = True
    colored_pawns[49] = "green"
    ...
    def safety_update(btn, index, safety, s_ims):
        ...
        if index == 5:
            ...
            if WIN[TURN] == 1:
                ...
                print(TURN, "wins")
                label1.configure(text=(TURN, "WINS"))
                print(WIN)
            else:
    ...
    for i in range(14):
        if i != 10:
            ...
            # red start zone
            r_start_img = PhotoImage(file = 'regSquare.gif')
    ...
    # blue start zone
    b_start_img = PhotoImage(file = 'regSquare.gif')
    ...
    for i in range(14):
        if i != 3:
            ...
            # yellow start zone
            y_start_img = PhotoImage(file = 'regSquare.gif')
    ...
    for i in range(6):
        ...
        g_index -= 1
    # green start
    g_start_img = PhotoImage(file = 'regSquare.gif')

...
btn = Button(insideleft , fg = 'red', text = "•", height=0, width=0, command=lambda:start_zone(btn, "blue"))
...
for i in range(6):
    ...
    g_index -= 1
# green start 
btn = Button(insideright, text = "  " , height=0, width=0, command=lambda:p.player("green"))
